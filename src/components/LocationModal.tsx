      ...
      <div className="bg-white w-full sm:max-w-lg sm:rounded-2xl rounded-t-2xl max-h-[95vh] overflow-y-auto shadow-2xl">
        ...
        <div className="bg-dark text-white p-5 sm:rounded-t-2xl rounded-t-2xl">
          ...
          <div className="flex gap-2 mt-3">
            <div className={`h-1.5 flex-1 rounded-full ${modalStep >= 1 ? 'bg-primary' : 'bg-white/20'}`} />
            <div className={`h-1.5 flex-1 rounded-full ${modalStep >= 2 ? 'bg-primary' : 'bg-white/20'}`} />
          </div>
        </div>
          ...
          {modalStep === 2 && (
            <>
              ...
              <button
                ...
                className="flex items-center gap-1 text-sm text-gray-500 hover:text-dark transition"
              >
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
